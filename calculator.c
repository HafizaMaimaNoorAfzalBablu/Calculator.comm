...
int main()
{
    ...
    printf("Do you want to know about us? (y/n): ");
    while ((getchar()) != '\n');
    scanf("%c", &x);
    ...
    if (x == 'y' || x == 'Y')
    {
        ...
        printf(" Team Members:\n");
        printf(" - Hafiza Maima Noor (BITF24M012)\n");
        printf(" - Aqsa (BITF24M019)\n");
        printf(" - Emaan Fatima (BITF24M021)\n\n");
        printf("\t\t\t====== Hope you enjoy using it! ====== \n");
    }
    else
    {
        printf("\n\t\t\t=============== Thanks Again ===============\n");
